...
docker run -d -e ADMIN_TENANT_NAME=$ADMIN_TENANT_NAME -e GLANCE_DB_NAME=$GLANCE_DB_NAME -e GLANCE_DB_USER=$GLANCE_DB_USER -e GLANCE_KEYSTONE_USER=$GLANCE_KEYSTONE_USER -e KEYSTONE_AUTH_PROTOCOL=$KEYSTONE_AUTH_PROTOCOL -e KEYSTONE_PUBLIC_SERVICE_HOST=$KEYSTONE_PUBLIC_SERVICE_HOST -e GLANCE_KEYSTONE_PASSWORD=$GLANCE_KEYSTONE_PASSWORD -e GLANCE_DB_PASSWORD=$GLANCE_DB_PASSWORD -e MARIADB_SERVICE_HOST=$HOST_IP -e KEYSTONE_ADMIN_TOKEN=$KEYSTONE_ADMIN_TOKEN -e KEYSTONE_ADMIN_SERVICE_HOST=$KEYSTONE_ADMIN_SERVICE_HOST -e PUBLIC_IP=$PUBLIC_IP -e DB_ROOT_PASSWORD=$MYSQL_ROOT_PASSWORD -e GLANCE_API_SERVICE_HOST=$GLANCE_API_SERVICE_HOST kollaglue/fedora-rdo-glance-api

docker run -d -e ADMIN_TENANT_NAME=$ADMIN_TENANT_NAME -e GLANCE_DB_NAME=$GLANCE_DB_NAME -e GLANCE_DB_USER=$GLANCE_DB_USER -e GLANCE_KEYSTONE_USER=$GLANCE_KEYSTONE_USER -e KEYSTONE_AUTH_PROTOCOL=$KEYSTONE_AUTH_PROTOCOL -e KEYSTONE_PUBLIC_SERVICE_HOST=$KEYSTONE_PUBLIC_SERVICE_HOST -e GLANCE_KEYSTONE_PASSWORD=$GLANCE_KEYSTONE_PASSWORD -e GLANCE_DB_PASSWORD=$GLANCE_DB_PASSWORD -e MARIADB_SERVICE_HOST=$HOST_IP -e KEYSTONE_ADMIN_TOKEN=$KEYSTONE_ADMIN_TOKEN -e KEYSTONE_ADMIN_SERVICE_HOST=$KEYSTONE_ADMIN_SERVICE_HOST -e PUBLIC_IP=$PUBLIC_IP -e DB_ROOT_PASSWORD=$MYSQL_ROOT_PASSWORD -e GLANCE_API_SERVICE_HOST=$GLANCE_API_SERVICE_HOST kollaglue/fedora-rdo-glance-registry
