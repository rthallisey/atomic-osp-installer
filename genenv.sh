...
# For all-in-one installs you need to use this:
NOVA_PUBLIC_INTERFACE=br100
...
CINDER_API_SERVICE_HOST=$CINDER_API_SERVICE_HOST
VOLUME_API_LISTEN=$VOLUME_API_LISTEN
